 ...
 * Контролы на карте
 *
 * По-хорошему, на каждый контрол нужен отдельный класс - конструктор, декларация, добавление, бинды разных действий
 *
 * А тут нужно хранить только совокупное состояние контролов
 */
class MapControls {
    static VERSION = '2024-06-23';
